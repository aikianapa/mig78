            ...
            <div class="row g-0 align-items-center">
                ...
                <div class="col-xl-6 col-lg-8 mx-auto">
                    <div class="title-section mb-3 text-center">
                        ...
                        <a href="{{top_link}}" class="btn btn-lg btn-dark btn-hover-dark" wb-if="top_button > ''">{{top_button}}</a>
                    </div>
                </div>
                <!-- title section end -->
                    ...
                    <div id="grid" class="grid row mb-n7">
                        <div class="grid-item mb-7">
                            <div class="feature-card bg-light">
                                ...
                                <img class="logo" width="74" height="74" src="assets/images/feature/logo/1.png" alt="{{header_blk1}}" wb-if="'{{image_blk1.0.img}}' == ''">
                                <img class="logo" width="74" height="74" src="/thumb/74x74/src/{{image_blk1.0.img}}" alt="{{header_blk1}}" wb-if="'{{image_blk1.0.img}}' > ''">
                                <h4 class="title my-6">
                        ...
                        <div class="grid-item card-mt-75 mb-7">
                            <div class="feature-card bg-light active">
                                <span class="card-shape card-shape-light"></span>
                                <span class="card-shape card-shape-dark"></span>
                                <img class="logo" width="74" height="74" src="assets/images/feature/logo/2.png" alt="{{header_blk2}}" wb-if="'{{image_blk2.0.img}}' == ''">
                                <img class="logo" width="74" height="74" src="/thumb/74x74/src/{{image_blk2.0.img}}" alt="{{header_blk2}}" wb-if="'{{image_blk2.0.img}}' > ''">
                                <h4 class="title my-6">
                        ...
                        <div class="grid-item mb-7">
                            <div class="feature-card bg-light">
                                <span class="card-shape card-shape-light"></span>
                                <span class="card-shape card-shape-dark"></span>
                                <img class="logo" width="74" height="74" src="assets/images/feature/logo/3.png" alt="{{header_blk3}}" wb-if="'{{image_blk3.0.img}}' == ''">
                                <img class="logo" width="74" height="74" src="/thumb/74x74/src/{{image_blk3.0.img}}" alt="{{header_blk3}}" wb-if="'{{image_blk3.0.img}}' > ''">
                                <h4 class="title my-6">
...
<edit header="Особенности (3 блока)">
    <div>
    ...
    <div class="divider-text">Верхняя часть</div>
        <div class="row">
            <div class="col-12">
                    <div class="row">
        ...
        <div class="row">
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-lg-8 mb-2">
                            <input class="form-control" type="text" name="header_blk1" placeholder="{{_lang.header}}">
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12 mb-2">
                            <textarea class="form-control" name="text_blk1" rows="auto" placeholder="{{_lang.text}}"></textarea>
                        </div>
                    </div>
                </div>
        </div>
        <div class="divider-text">Центральный блок</div>
        ...
        <div class="row">
                <div class="col-12">
                    <div class="row">
                        <label class="form-control-label col-lg-4">{{_lang.header}}</label>
                        <div class="col-lg-8 mb-2">
                            <input class="form-control" type="text" name="header_blk2" placeholder="{{_lang.header}}">
                        </div>
                    </div>
                    <div class="row">
                        <label class="form-control-label col-lg-4">{{_lang.link}}</label>
                    ...
                    <div class="row">
                        <div class="col-12 mb-2">
                            <textarea class="form-control" name="text_blk2" rows="auto" placeholder="{{_lang.text}}"></textarea>
                        </div>
                    </div>
                </div>
        </div>
        ...
        <div class="row">
                <div class="col-12">
                    <div class="row">
                        <label class="form-control-label col-lg-4">{{_lang.header}}</label>
                        <div class="col-lg-8 mb-2">
                            <input class="form-control" type="text" name="header_blk3" placeholder="{{_lang.header}}">
                        </div>
                    </div>
                    <div class="row">
                        <label class="form-control-label col-lg-4">{{_lang.link}}</label>
                    ...
                    <div class="row">
                        <div class="col-12 mb-2">
                            <textarea class="form-control" name="text_blk3" rows="auto" placeholder="{{_lang.text}}"></textarea>
                        </div>
                    </div>
                </div>
        </div>
